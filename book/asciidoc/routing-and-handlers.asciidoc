...
neverExpires:: Set the Expires header to a date one year from now. You can use
this with content which should never expire, such as when the request path has a
